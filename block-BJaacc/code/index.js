...
students.studentName = `Chandan Kumar`;
...
// 11. Can you define a key of `let or var` in any object? Reason. Both `let or var` is used declare a variable but `let` is used for declaring the variable in block, statement or expression on which it is used, and var is used for entire function.
