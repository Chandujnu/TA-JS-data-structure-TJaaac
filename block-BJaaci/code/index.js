...
console.log(movies[movies.length - 1].actors[0])
...
console.log(movies[movies.length - 2].genres[0])
...
if(movies[1].actors[1] = 'Jennifer Jason Leigh') {
  console.log(true);
} else {
  console.log(false);
}
